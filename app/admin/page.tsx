  ...
  return (
    <div className="min-h-screen bg-background-light">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header Section */}
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-2">Shop Manager Dashboard</h1>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <p className="text-xl text-gray-600">Welcome back, Shop Manager</p>
            <p className="text-sm text-gray-500">{currentDate}</p>
          </div>
          <p className="text-sm text-gray-500 mt-2">
            Instagram: <a href="https://instagram.com/tick.teestyle" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">@tick.teestyle</a> | Manage your watch inventory and customer orders
          </p>
        </div>
        ...
        {/* Quick Actions */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Shop Management</h2>
